  ...
  return (
    <div className="min-h-dvh bg-white pb-24">
      ...
      <div className="px-5 pt-12 pb-6"
        ...
        <h1 style={{ fontSize: 22, fontWeight: 800, color: 'white', marginBottom: 16 }}>Work History</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p style={{ color: '#9e9e9e', fontSize: 13 }}>
              Complete your first order to build your work history
            </p>
          </div>
        ) : (
          <>
            <h2 style={{ fontSize: 16, fontWeight: 700, color: '#1a1a1a', marginBottom: 12 }}>
              Completed Work ({delivered.length})
            </h2>
            <div className="flex flex-col gap-3">
              {delivered.map(order => {
                const svcLabel = order.service_type === 'from_scratch' ? 'From Scratch' :
                  order.service_type === 'upcycling' ? 'Upcycling' : 'Alterations'
